...
\begin{figure}[htb]
 %\centering
 \rotatebox{-90}{\includegraphics[width=6.5cm]{2aaprim.eps}}
...
\begin{figure}[htb]
 \centering
 \rotatebox{-90}{\includegraphics[width=6.5cm]{EGDEG2aaprim.eps}}
...
\end{equation}
where $a$ is the droplet radius. $n_i$, $D_i$ and $\rho_{{\rm sat},i}$ are the $i$-th component amount, vapour-in-gas diffusion coefficient and saturated vapour molar concentration. The Raoult's law is applied here in its equilibrium form (compare derivation of K\:{o}hler equations in \cite{Pruppacher} (p.172)) for the lack of a better analytical form. For a microdroplet, the effects of surface tension (described with the Kelvin term) are negligible. Further on, for relatively slow evaporation, evaporative cooling can also be neglected.
...
\begin{figure}[htb]
 \centering
\rotatebox{-90}{\includegraphics[width=6.5cm]{kinks.eps}}
...
\begin{figure}[htb]
 \centering
 \rotatebox{-90}{\includegraphics[width=6.5cm]{exp_a0.eps}}
